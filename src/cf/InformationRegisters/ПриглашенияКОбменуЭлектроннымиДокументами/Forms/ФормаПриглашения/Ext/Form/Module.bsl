...
Процедура НастроитьФорму()
	...
	ДанныеПриглашения.Вставить("ИдентификаторОрганизации", ИдентификаторОрганизации);
	ДанныеПриглашения.Вставить("ИдентификаторКонтрагента", ИдентификаторКонтрагента);
	ДанныеПриглашения.Вставить("ОператорЭДО", ОператорКонтрагента);
	
	ОбменСКонтрагентамиСлужебный.ЗаменитьПредставлениеСтатусаПриглашения(ДанныеПриглашения, "СтатусПодключения", СтатусПодключения, ЭтаФорма);
