...
Процедура ЗаписатьНаборСловВСтатистикуСловСловаря(Знач ТипОбъекта, ЕстьОтработанныеЗаписи, ПроизошлаОшибка, ТекстСообщения)
	...
	Результат = ОбменСКонтрагентамиСлужебный.ПолучитьСтатистикуСловИспользованияВСловареСопоставленияНоменклатурыБЭД(ТипОбъекта);
	...
	Пока Выборка.Следующий() Цикл
		...
		Попытка
			...
			НаборЗаписейСтатистикиСлов = ОбменСКонтрагентамиСлужебный.ЗаполнитьНаборЗаписейСтатистикиСловВСловаре(Выборка, ТипОбъекта);
