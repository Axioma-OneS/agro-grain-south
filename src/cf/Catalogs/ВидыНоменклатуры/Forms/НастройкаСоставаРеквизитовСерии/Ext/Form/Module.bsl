		...
		Если Не ИспользоватьДатуПроизводстваСерии
			И ((АлкогольнаяПродукция
				...
				Или ((ПодконтрольнаяПродукцияВЕТИС
					  Или ОсобенностьУчета = ПредопределенноеЗначение("Перечисление.ОсобенностиУчетаНоменклатуры.МолочнаяПродукция"))
...
Процедура НастроитьФорму()
	...
	ПродукцияИСМП.Добавить(Перечисления.ОсобенностиУчетаНоменклатуры.МолочнаяПродукция);
	...
	МолочнаяПродукция = (ОсобенностьУчета = Перечисления.ОсобенностиУчетаНоменклатуры.МолочнаяПродукция);
	...
	Элементы.ИспользоватьПроизводителяВЕТИССерии.Видимость           = ПодконтрольнаяПродукцияВЕТИС Или МолочнаяПродукция;
	Элементы.ИспользоватьЗаписьСкладскогоЖурналаВЕТИССерии.Видимость = ПодконтрольнаяПродукцияВЕТИС Или МолочнаяПродукция;
	Элементы.ИспользоватьИдентификаторПартииВЕТИССерии.Видимость     = ПодконтрольнаяПродукцияВЕТИС Или МолочнаяПродукция;
