...
Процедура УстановитьСоответствиеНоменклатуры()
	...
	Для Каждого СтрокаТовара Из Товары Цикл
		...
		Если Не СоответствиеНайдено Тогда
			ДанныеНоменклатурыКонтрагента = ОбменСКонтрагентамиКлиентСервер.НоваяНоменклатураКонтрагента(
			...
			ДанныеНоменклатуры = ОбменСКонтрагентамиКлиентСервер.НоваяНоменклатураИнформационнойБазы(
			...
			ОбменСКонтрагентами.УстановитьСоответствиеНоменклатуры(ДанныеНоменклатурыКонтрагента,
