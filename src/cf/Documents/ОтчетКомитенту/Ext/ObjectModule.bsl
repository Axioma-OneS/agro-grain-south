...
Процедура ЗаполнитьДанныеСчетовФактур()
	...
	ТаблицаТовары = Товары.Выгрузить(, "АналитикаУчетаНоменклатуры,СтавкаНДС,ДатаСчетаФактуры,Покупатель,СчетФактураВыставленный,Количество,СуммаСНДС,СуммаНДС,СуммаВознаграждения,СуммаПродажи");
	ТаблицаТовары.Свернуть("АналитикаУчетаНоменклатуры,СтавкаНДС,ДатаСчетаФактуры,Покупатель,СчетФактураВыставленный",
							"Количество,СуммаСНДС,СуммаНДС,СуммаВознаграждения,СуммаПродажи");
	...
	Для Каждого СтрокаТоваров Из ТаблицаТовары Цикл
		...
		Для Каждого СтрокаЗапасов Из ВидыЗапасов.НайтиСтроки(СтруктураПоиска) Цикл
			...
			НоваяСтрока.СуммаНДС = (СтрокаЗапасов.СуммаНДС / СтрокаЗапасов.Количество) * Количество;
