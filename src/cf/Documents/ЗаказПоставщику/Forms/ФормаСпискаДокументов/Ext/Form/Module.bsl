...
//
&НаКлиенте
Процедура ОтборПоступленияНаСкладЗавершеныПриИзменении(Элемент)
	
	ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбораДинамическогоСписка(Список, "ПоступленияНаСкладЗавершены", ОтборПоступленияНаСкладЗавершены, ВидСравненияКомпоновкиДанных.Равно);	
