...
Функция ТекстЗапросаВтПодарочныеСертификатыОстатки(Запрос, ТекстыЗапроса)
	...
	|ИЗ РегистрНакопления.ПодарочныеСертификаты КАК ПодарочныеСертификаты
	|ГДЕ
...
Функция ТекстЗапросаИсторияПодарочныхСертификатов(Запрос, ТекстыЗапроса, Регистры)
	...
	|				И МАКСИМУМ(ТабличнаяЧасть.СуммаВВалютеСертификата) + СУММА(ЕСТЬNULL(Остатки.Сумма, 0)) <> ТабличнаяЧасть.ПодарочныйСертификат.Владелец.Номинал
	...
	|	ТабличнаяЧасть.ПодарочныйСертификат.Владелец.Номинал";
