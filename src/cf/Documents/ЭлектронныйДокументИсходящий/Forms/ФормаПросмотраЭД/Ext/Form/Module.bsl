...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИначеЕсли Параметры.Свойство("АдресФайловЭД", АдресФайловЭД)
		...
		Параметры.Свойство("ТекущиеНастройкиОбмена", ТекущиеНастройкиОбмена);
...
Процедура ПередЗаписью(Отказ, ПараметрыЗаписи)
	...
	ИначеЕсли Не ЗначениеЗаполнено(Объект.Ссылка) Тогда
		...
		Если ЗначениеЗаполнено(ТекущиеНастройкиОбмена) Тогда 
			КэшНастроек = Новый Соответствие;
			Для Каждого ДокументУчета Из МассивДокументовУчета(Объект) Цикл 
				КэшНастроек.Вставить(ДокументУчета, ТекущиеНастройкиОбмена);
			КонецЦикла;
			ДополнительныеПараметры.Вставить("НастройкиОбмена", КэшНастроек);
		КонецЕсли;
