...
Функция РазрабатываемыеПодсистемы() Экспорт
	...
	Результат = Новый Массив;
	Результат.Добавить("УправлениеТорговлей" + ?(СтандартныеПодсистемыСервер.ЭтоБазоваяВерсияКонфигурации(), "Базовая", ""));
	Результат.Добавить("КомплекснаяАвтоматизация");
	Результат.Добавить("УправлениеПредприятием");
	Результат.Добавить("ERPWE");
	Результат.Добавить("Локализация" + ?(СтандартныеПодсистемыСервер.ЭтоБазоваяВерсияКонфигурации(), "Базовая", ""));
	Возврат Результат;
