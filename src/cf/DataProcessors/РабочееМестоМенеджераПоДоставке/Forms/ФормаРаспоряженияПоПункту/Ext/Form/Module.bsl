...
#КонецОбласти
    ...
    // Карло... 09.10.2020
	Если Параметры.Свойство("ЗаданиеНаПеревозку") Тогда 
		СтатусПодтвержденияУстановлен = Параметры.ЗаданиеНаПеревозку.СтатусПодтверждения = Перечисления.СтатусыПодтверждения.ПодтвержденоБухгалтерией;
	КонецЕсли;
	// ...И.В.
...
Процедура ПриОткрытии(Отказ)
	...
	// Карло... 09.10.2020
	ЭтаФорма.ТолькоПросмотр = СтатусПодтвержденияУстановлен;
	// ...И.В.
