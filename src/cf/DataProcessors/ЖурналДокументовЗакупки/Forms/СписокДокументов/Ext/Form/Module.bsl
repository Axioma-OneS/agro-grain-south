...
// Карло... 04.10.2020
&НаКлиенте
Процедура ЗаказПоставщикаПриИзменении(Элемент)
	
	УстановитьОтборПоЗаказуПоставщика();
	ПодключитьОбработчикОжиданияГиперссылкиКОформлению();
...
// Карло... 04.10.2020
&НаСервере
Процедура УстановитьОтборПоЗаказуПоставщика()
	...
	ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбораДинамическогоСписка(
		...
		ВидСравненияКомпоновкиДанных.Равно,
		,
		ЗначениеЗаполнено(ЗаказПоставщика));
