...
Процедура УстановитьДоступность(РеквизитПутьКДанным = "")
	...
	Если РеквизитПутьКДанным = "НаборКонстант.ИспользоватьУправлениеДоставкой" ИЛИ РеквизитПутьКДанным = "" Тогда
		...
		// ЭлектронноеВзаимодействие.СервисДоставки
		ИспользоватьСервис1СДоставка               = Константы.ИспользоватьСервис1СДоставка.Получить();
		Элементы.ГруппаКомментарийИспользоватьУправлениеДоставкой.Видимость = ИспользоватьСервис1СДоставка;
		Элементы.ИспользоватьУправлениеДоставкой.Доступность = Не ИспользоватьСервис1СДоставка;
		// Конец ЭлектронноеВзаимодействие.СервисДоставки
