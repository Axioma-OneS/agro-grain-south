...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Страницы = СервисДоставки.НовыйПараметрыСтраницСервиса(20);
...
Процедура ОтборОтправительОбработкаВыбора(Элемент, ВыбранноеЗначение, СтандартнаяОбработка)
	...
	ОбработатьВыборТипаУчастникаГрузоперевозки(Элемент, ВыбранноеЗначение);
...
Функция ПараметрыЗапросаОтменитьЗаказНаДоставку(ПараметрыОперации, Отказ)
	...
	Если ТекущиеДанные.СостояниеИдентификатор <> 0 Тогда
		ТекстСообщения = СтрШаблон(
			НСтр("ru='Отменить заказ можно только в состоянии ""Черновик"". Текущее состояние ""%1"".'"),
...
&НаКлиенте
Процедура ОбработатьВыборТипаУчастникаГрузоперевозки(Элемент, ВыбранноеЗначение)
