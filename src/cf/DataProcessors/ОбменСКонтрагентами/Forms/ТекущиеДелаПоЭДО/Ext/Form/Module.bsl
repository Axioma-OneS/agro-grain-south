...
&НаСервереБезКонтекста
Процедура ПриглашенияЭДПриПолученииДанныхНаСервере(ИмяЭлемента, Настройки, Строки)
	
	ОбменСКонтрагентамиСлужебный.ЗаменитьПредставлениеСтатусовПриглашений(Строки, "СтатусПодключения");
...
Процедура ИнициализироватьРазделы()
	...
	ДобавитьОписаниеРаздела("Входящие", НСтр("ru = 'Входящие'"), , ОбщегоНазначения.ЭтоМобильныйКлиент());
	...
	ДобавитьОписаниеРаздела("Исходящие", НСтр("ru = 'Исходящие'"), , ОбщегоНазначения.ЭтоМобильныйКлиент());
	...
	ДобавитьОписаниеРаздела("Ошибки", НСтр("ru = 'Ошибки'"));
...
Процедура ПроверитьВозможностьПодписанияДокументов(Знач ДокументыНаПроверку)
	...
	Пока Выборка.Следующий() Цикл
		ТекстСообщения = СтрШаблон(НСтр("ru = 'Документ ""%1 № %2 от %3"" не доступен для подписания текущим пользователем.'"),
