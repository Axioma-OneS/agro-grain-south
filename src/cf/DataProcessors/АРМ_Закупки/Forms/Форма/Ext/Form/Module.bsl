...
Функция СохранитьДокумент_Перевозка(Параметры)
	...
	Исключение
		...
		ТекстСообщения = СтрШаблон("Описание ошибки: %1", ОписаниеОшибки());
		ЗаписьЖурналаРегистрации("АРМ_Закупки.Форма.АРМ_Закупки", УровеньЖурналаРегистрации.Ошибка, , ОбъектЗаписиПеревозка.Ссылка, ТекстСообщения);
		СообщениеПользователю = Новый СообщениеПользователю;
		СообщениеПользователю.Текст = ТекстСообщения;
		СообщениеПользователю.Сообщить();
	...
	Исключение
		...
		ТекстСообщения = СтрШаблон("Описание ошибки: %1", ОписаниеОшибки());
		ЗаписьЖурналаРегистрации("АРМ_Закупки.Форма.АРМ_Закупки", УровеньЖурналаРегистрации.Ошибка, , ОбъектЗаписиПоступление.Ссылка, ТекстСообщения);
		СообщениеПользователю = Новый СообщениеПользователю;
		СообщениеПользователю.Текст = ТекстСообщения;
		СообщениеПользователю.Сообщить();
