...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если РаботаСНоменклатурой.ВыгрузкаНоменклатурыИспользуется() 
		И ПравоДоступа("Просмотр", Метаданные.Обработки.РаботаСНоменклатурой.Команды.ВыгрузитьНоменклатуру) Тогда
