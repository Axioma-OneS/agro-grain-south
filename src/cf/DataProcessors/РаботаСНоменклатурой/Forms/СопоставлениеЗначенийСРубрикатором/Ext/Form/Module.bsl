...
Процедура ЗаполнитьЗначенияРеквизита(Команда)
	...
	Для Каждого СтрокаСписка Из Список Цикл
		...
		СтрокаПоиска = СписокЗначенийСервиса.НайтиПоЗначению(Строка(СтрокаСписка.Значение));
...
Процедура ОбновитьСписокЗначенийРеквизита()
	...
	РаботаСНоменклатуройПереопределяемый.ПолучитьСопоставленныеЗначенияРеквизитаВидаНоменклатуры(
		ОбъектСопоставления, РеквизитОбъекта, ТипЗначения, ТаблицаЗначений);
		
	Если НЕ ТаблицаЗначений.Количество()
		...
		МодульТорговыеПредложенияПереопределяемый.ПолучитьСопоставленныеЗначенияРеквизитаВидаНоменклатуры(
			ОбъектСопоставления, РеквизитОбъекта, ТипЗначения, ТаблицаЗначений);
