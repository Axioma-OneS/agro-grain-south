...
Процедура ЗапроситьПаролиСертификатов(Контекст) 
	...
	Иначе 
		...
		Сертификаты = РезультатДиагностикиКриптографии.ПривязанныеКУчетнымЗаписямСертификаты;
...
Процедура ПроверкиСертификатов(Контекст)
	...
	Сертификаты = Контекст.ПараметрыВыполнения.РезультатДиагностики.Результаты.Криптография.ПривязанныеКУчетнымЗаписямСертификаты;
	Обработчики = Новый Массив;
...
Процедура ПроверкиСертификатовПослеЦикла(Результат, Контекст) Экспорт
	...
	КонецЕсли;
	КоличествоДанных = Контекст.ПараметрыВыполнения.РезультатДиагностики.Результаты.Криптография.ПривязанныеКУчетнымЗаписямСертификаты.Количество();
