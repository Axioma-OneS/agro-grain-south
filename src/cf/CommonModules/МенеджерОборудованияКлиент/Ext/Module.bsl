...
// Процедура показывает форму выбора из классификатора кода вида номенклатурной классификации.
// Параметры:
//  ОповещениеПриВыборе - ОписаниеОповещения - вызывается после завершения выбора.
//
...
// Завершение процедуры показа формы выбора из классификатора кода вида номенклатурной классификации.
// Параметры:
//  Результат - Структура - Результат операции.
