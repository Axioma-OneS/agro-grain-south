...
//   * КодТарифаОбслуживающейОрганизации - код тарифа обслуживающей организации
...
Функция ПереименованияПолей(Метод)
	...
	ИначеЕсли Метод = "account/servant_tariffs/list" Тогда
		Переименования.Вставить("id", ОписаниеКолонки(
			"Код", ОбщегоНазначения.ОписаниеТипаСтрока(9)));
		Переименования.Вставить("name", ОписаниеКолонки(
			"Наименование", ОбщегоНазначения.ОписаниеТипаСтрока(150)));
		Переименования.Вставить("tariff_id", ОписаниеКолонки(
	...
	ИначеЕсли Метод = "subscription/list" Тогда
