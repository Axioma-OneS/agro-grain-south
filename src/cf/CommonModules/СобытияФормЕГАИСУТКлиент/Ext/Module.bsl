...
Процедура ПриИзмененииЭлемента(Форма, Элемент, ДополнительныеПараметры) Экспорт
	...
	ИначеЕсли Форма.ИмяФормы = "ОбщаяФорма.ПроверкаЗаполненияДокументов" Тогда
		...
		Если Элемент = Форма.Элементы.ТоварыКоличествоУпаковокФакт Тогда
			...
			Если Форма.ИспользоватьАкцизныеМарки Тогда
				...
				ОбработкаТабличнойЧастиКлиент.ОбработатьСтрокуТЧ(ТекущаяСтрока, СтруктураДействий, ДополнительныеПараметры.КэшированныеЗначения);
