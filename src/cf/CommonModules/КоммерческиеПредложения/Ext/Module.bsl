...
//
// Параметры:
//  Документ - ДокументСсылка - Ссылка на учетный документ, который необходимо проверить перед отправкой (обновлением).
...
//
// Параметры:
//  Документ - ДокументСсылка - Ссылка на учетный отправляемый или обновляемый документ.
//                              См. ОпределяемыйТип.ЗапросКоммерческихПредложенийПоставщиков.
//
// Возвращаемое значение:
//  Структура - Ключи:
