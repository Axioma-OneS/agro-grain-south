...
Функция ЗапросGTINпоТаблицеМаркируемойПродукции(ВидМаркируемойПродукции, ТаблицаМаркируемойПродукции)
	...
	// TODO: состав колонок формируется с учетом вида продукции
	ДополнительныеКолонки = "";
	Если ВидМаркируемойПродукции = Перечисления.ВидыПродукцииИС.МолочнаяПродукция Тогда
		ДополнительныеКолонки = "
		|	,
		|	МаркируемаяПродукция.ИдентификаторПроисхожденияВЕТИС КАК ИдентификаторПроисхожденияВЕТИС,
		|	МаркируемаяПродукция.Скоропортящаяся                 КАК Скоропортящаяся,
		|	МаркируемаяПродукция.ГоденДо                         КАК ГоденДо";
	КонецЕсли;
	...
	ТекстЗапроса = СтрШаблон(ТекстЗапроса, ДополнительныеКолонки);
