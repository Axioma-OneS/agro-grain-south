...
#Область ОбновитьЗависимыеКонстанты

	Обработчик = Обработчики.Добавить();
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыУТ.ОбновитьЗависимыеКонстанты";
	Обработчик.Версия = "11.4.12.81";
	Обработчик.РежимВыполнения = "Монопольно";
	Обработчик.НачальноеЗаполнение = Ложь;
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("f28aff4f-ef5f-49ec-a2e2-96c9a9405750");
	Обработчик.Комментарий = НСтр("ru = 'Обновляет значения зависимых констант.'");
...
Процедура ОбновитьЗависимыеКонстанты() Экспорт
	...
	ТаблицаРодители = ТаблицаКонстант.Скопировать(,"ИмяРодительскойКонстанты");
	ТаблицаРодители.Свернуть("ИмяРодительскойКонстанты");
	
	РодительскиеКонстанты = ТаблицаРодители.ВыгрузитьКолонку("ИмяРодительскойКонстанты");
	
	МетаданныеКонстант = Метаданные.Константы;
	
	ДобавитьКонстанту(РодительскиеКонстанты, "БазоваяВерсия");
	ДобавитьКонстанту(РодительскиеКонстанты, "РазрешитьОбособлениеТоваровСверхПотребности");
	ДобавитьКонстанту(РодительскиеКонстанты, "ИспользоватьПеремещениеТоваров");
	ДобавитьКонстанту(РодительскиеКонстанты, "ИспользоватьЗаказыПоставщикам");
	ДобавитьКонстанту(РодительскиеКонстанты, "ИспользоватьЗаказыНаПеремещение");
	ДобавитьКонстанту(РодительскиеКонстанты, "ИспользоватьЗаказыНаСборку");
	ДобавитьКонстанту(РодительскиеКонстанты, "ИспользоватьПроизводство");
	ДобавитьКонстанту(РодительскиеКонстанты, "ИспользоватьОплатуПлатежнымиКартами");
	ДобавитьКонстанту(РодительскиеКонстанты, "ИспользоватьПодключаемоеОборудование");
	ДобавитьКонстанту(РодительскиеКонстанты, "ИспользоватьНесколькоКасс");
	ДобавитьКонстанту(РодительскиеКонстанты, "ИспользоватьНесколькоРасчетныхСчетов");
	ДобавитьКонстанту(РодительскиеКонстанты, "ИспользоватьНесколькоВалют");
	ДобавитьКонстанту(РодительскиеКонстанты, "ИспользоватьЗаказыКлиентов");
	ДобавитьКонстанту(РодительскиеКонстанты, "ИспользоватьЗаявкиНаВозвратТоваровОтКлиентов");
	ДобавитьКонстанту(РодительскиеКонстанты, "ИспользоватьРасширенныеВозможностиЗаказаКлиента");
	ДобавитьКонстанту(РодительскиеКонстанты, "ИспользоватьСогласованиеЗаявокНаВозвратТоваровОтКлиентов");
	ДобавитьКонстанту(РодительскиеКонстанты, "ИспользоватьСогласованиеЗаказовКлиентов");
	ДобавитьКонстанту(РодительскиеКонстанты, "ИспользоватьСогласованиеСоглашенийСКлиентами");
	ДобавитьКонстанту(РодительскиеКонстанты, "ИспользоватьСделкиСКлиентами");
	ДобавитьКонстанту(РодительскиеКонстанты, "ИспользоватьУправлениеСделками");
	ДобавитьКонстанту(РодительскиеКонстанты, "ИспользоватьПострочнуюОтгрузкуВЗаказеКлиента");
	ДобавитьКонстанту(РодительскиеКонстанты, "ИспользоватьЗаказыНаПеремещение");
	ДобавитьКонстанту(РодительскиеКонстанты, "ИспользоватьЗаказыНаВнутреннееПотребление");
	ДобавитьКонстанту(РодительскиеКонстанты, "ИспользоватьЗаказыНаСборку");
	ДобавитьКонстанту(РодительскиеКонстанты, "ДетализироватьЗаданияТорговымПредставителямПоНоменклатуре");
	ДобавитьКонстанту(РодительскиеКонстанты, "ИспользованиеЗаданийТорговымПредставителям");
	ДобавитьКонстанту(РодительскиеКонстанты, "ИспользоватьРучныеСкидкиВПродажах");
	ДобавитьКонстанту(РодительскиеКонстанты, "ИспользоватьАвтоматическиеСкидкиВПродажах");
	ДобавитьКонстанту(РодительскиеКонстанты, "ИспользоватьСчетаНаОплатуКлиентам");
	ДобавитьКонстанту(РодительскиеКонстанты, "ИспользоватьПроизводство");
	ДобавитьКонстанту(РодительскиеКонстанты, "ИспользоватьПроизводствоНаСтороне");
	ДобавитьКонстанту(РодительскиеКонстанты, "ИспользоватьУправлениеПроизводством");
	ДобавитьКонстанту(РодительскиеКонстанты, "ИспользоватьУправлениеПроизводством2_2");
	ДобавитьКонстанту(РодительскиеКонстанты, "ИспользоватьВнеоборотныеАктивы2_2");
	ДобавитьКонстанту(РодительскиеКонстанты, "ИспользоватьВнеоборотныеАктивы2_4");
	ДобавитьКонстанту(РодительскиеКонстанты, МетаданныеКонстант.ИспользоватьСогласованиеЧерез1СДокументооборот.Имя);
	ДобавитьКонстанту(РодительскиеКонстанты, МетаданныеКонстант.ОтображениеСкидокВПечатныхФормахДокументовПродажи.Имя);
	ДобавитьКонстанту(РодительскиеКонстанты, МетаданныеКонстант.ИспользоватьИмпортныеЗакупки.Имя);
	ДобавитьКонстанту(РодительскиеКонстанты, МетаданныеКонстант.ИспользоватьНеотфактурованныеПоставки.Имя);
	ДобавитьКонстанту(РодительскиеКонстанты, МетаданныеКонстант.ИспользоватьТоварыВПутиОтПоставщиков.Имя);
	ДобавитьКонстанту(РодительскиеКонстанты, МетаданныеКонстант.ИспользоватьИмпортныеТовары.Имя);
	ДобавитьКонстанту(РодительскиеКонстанты, МетаданныеКонстант.ИспользованиеКлассификаторовНоменклатуры.Имя);
	ДобавитьКонстанту(РодительскиеКонстанты, МетаданныеКонстант.ИспользоватьРеглУчет.Имя);
	ДобавитьКонстанту(РодительскиеКонстанты, МетаданныеКонстант.ВалютаРегламентированногоУчета.Имя);
	ДобавитьКонстанту(РодительскиеКонстанты, МетаданныеКонстант.ВалютаУправленческогоУчета.Имя);
	
	
	НачатьТранзакцию();
	Попытка
		
		Для Каждого ИмяРодительскойКонстанты Из РодительскиеКонстанты Цикл
			Константа = Константы[ИмяРодительскойКонстанты];
			
			Источник = Константа.СоздатьМенеджерЗначения();
			Источник.Значение = Константа.Получить();
			
			НастройкиСистемы.ПриЗаписиКонстанты(Источник, Ложь);
		КонецЦикла;
	...
	ЗаписьЖурналаРегистрации(
		НСтр("ru = 'Обновление зависимых констант'"),
		УровеньЖурналаРегистрации.Информация,,,
		НСтр("ru = 'Выполнение обработчика обновления успешно завершено'"));
	
КонецПроцедуры

Процедура ДобавитьКонстанту(РодительскиеКонстанты, ИмяКонстанты)
	
	Если РодительскиеКонстанты.Найти(ИмяКонстанты) = Неопределено
			И Метаданные.Константы.Найти(ИмяКонстанты) <> Неопределено Тогда
		РодительскиеКонстанты.Добавить(ИмяКонстанты);
	КонецЕсли;
...
#Область УстановкаКонстанты_ИспользоватьСервис1СДоставка

Процедура УстановитьКонстантуИспользоватьСервис1СДоставка() Экспорт
	
	// ЭлектронноеВзаимодействие.СервисДоставки
	Если Константы.ИспользоватьСервис1СДоставка.Получить() Тогда
		Возврат; // уже установлена
	КонецЕсли;
	
	Если Константы.ИспользоватьОбменБизнесСеть.Получить()
		И Константы.ИспользоватьУправлениеДоставкой.Получить() Тогда
		Константы.ИспользоватьСервис1СДоставка.Установить(Истина);
	КонецЕсли;
