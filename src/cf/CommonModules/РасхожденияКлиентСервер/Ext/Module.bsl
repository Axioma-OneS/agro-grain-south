...
Процедура УправлениеДоступностью(Форма) Экспорт
	...
	ПодборТоваровДоступен = ПодборДокументовОснованийДоступен И (Форма.ДокументыОснования.Количество() > 0 ИЛИ Форма.Объект.ОснованиеДляСоставленияАкта = "Входящий электронный документ");
