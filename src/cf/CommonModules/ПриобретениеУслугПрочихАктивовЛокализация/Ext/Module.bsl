...
Процедура ОбработкаЗаполнения(Объект, ДанныеЗаполнения, СтандартнаяОбработка) Экспорт
	...
	// Автор: Карло... 02.05.2021
	// Описание: Заполняем на основании документа "Заявка на услуги"
	//
	Если ТипЗнч(ДанныеЗаполнения) = Тип("ДокументСсылка.ЗаявкаНаУслуги") Тогда 
		Объект.Менеджер 					= Пользователи.ТекущийПользователь();
		Объект.ДатаПлатежа 					= ТекущаяДатаСеанса();
		Объект.БанковскийСчетОрганизации 	= ДанныеЗаполнения.Договор.БанковскийСчет;
		Объект.БанковскийСчетКонтрагента 	= ДанныеЗаполнения.Договор.БанковскийСчетКонтрагента;
		...
		Объект.Распоряжение					= ДанныеЗаполнения;
	КонецЕсли;	
	//
	// ...И.В.
