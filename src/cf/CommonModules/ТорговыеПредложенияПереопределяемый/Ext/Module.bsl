...
Процедура ИнициализацияЗапросаПубликуемыхТоваров(Запрос) Экспорт
	...
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ РеквизитыБизнесСеть КАК РеквизитыБизнесСеть
	|		ПО НоменклатураДополнительныеРеквизиты.Свойство = РеквизитыБизнесСеть.РеквизитОбъекта
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ
	...
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ РеквизитыБизнесСеть КАК РеквизитыБизнесСеть
	|		ПО (ХарактеристикиНоменклатурыДополнительныеРеквизиты.Свойство = РеквизитыБизнесСеть.РеквизитОбъекта)
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ
	...
	|
	|////////////////////////////////////////////////////////////////////////////////
	|УНИЧТОЖИТЬ РеквизитыБизнесСеть
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
