...
Функция СтрокаАутентификации(ИдентификаторОрганизации, ПринудительноОбнолятьКлючДоступа = Ложь, Отказ = Ложь) Экспорт
	
	Результат = "";
	
	КлючДоступа = КлючДоступаБизнесСети(ИдентификаторОрганизации, ПринудительноОбнолятьКлючДоступа, Отказ);	
...
Функция ТокенДоступаОрганизации(Организация) Экспорт
	...
	КлючДоступа = КлючДоступаБизнесСети(ИдентификаторОрганизации, Отказ);
...
Функция ОбновитьКлючДоступа(ИдентификаторОрганизации, ТокенОбновления, Отказ = Ложь)
	...
	Если ПараметрыКоманды.КодСостояния = 403 Тогда
		ИнвалидироватьТокенОбновления(ИдентификаторОрганизации);
	КонецЕсли;
...
Функция КлючДоступаБизнесСети(
			ИдентификаторОрганизации, 
			ПринудительноОбнолятьКлючДоступа = Ложь, 
			Отказ = Ложь)
	...
	Попытка
		...
		КлючДоступа = ПолучитьОбновитьКлючДоступа(ИдентификаторОрганизации, ПринудительноОбнолятьКлючДоступа, Отказ);
...
Функция ПолучитьОбновитьКлючДоступа(ИдентификаторОрганизации, ПринудительноОбнолятьКлючДоступа, Отказ)
	...
	Если ЗначениеЗаполнено(КлючДоступа) Тогда
		...
		Если ТокенОбновленияИнвалидирован(КлючДоступа) Тогда
		...
		Если Не СрокТокенаДоступаАктуален(КлючДоступа) 
			ИЛИ ПринудительноОбнолятьКлючДоступа Тогда
...
Функция ТокенОбновленияИнвалидирован(КлючДоступа)
	...
	Результат = Не ЗначениеЗаполнено(КлючДоступа.ТокенОбновления);
	
	Возврат Результат;
	
КонецФункции

Процедура ИнвалидироватьТокенОбновления(ИдентификаторОрганизации)
	
	КлючДоступа = КлючДоступаИзЛокальногоХранилища(ИдентификаторОрганизации);
	
	КлючДоступа.ТокенОбновления = "";
...
Функция ИдентификаторыОрганизаций(Организации = Неопределено)
...
Функция ДанныеДляРегистрацииОрганизацииВБизнесСети(Организация)
	...
	Результат.Вставить("ЭлектроннаяПочта",                  ДанныеОрганизации.ЭлектроннаяПочта);
