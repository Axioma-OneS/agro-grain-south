...
Функция ПолучитьРасширенияДляНовойОбласти(Знач КодОбластиДанных) Экспорт 
	...
	Если НЕ МенеджерСервисаПоддерживаетПолучениеРасширенийДляНовойОбласти() Тогда
...
Функция ПолучитьПредупреждениеИзмененияСтруктурыДанных(Знач АдресХранилищаРезультат) Экспорт
	
	Возврат НачатьВыполнениеЗапроса(АдресХранилищаРезультат, Новый Структура, 
		"ПолучитьПредупреждениеИзмененияСтруктурыДанных");
...
Функция НачатьВыполнениеЗапроса(АдресХранилищаРезультат, ДопПараметры, НаименованиеМетода, ВыполнятьВФоне = Истина) 
	...
	ДоступныеМетоды = КаталогРасширенийПовтИсп.МетодыИнтерфейсаМенеджераСервиса();
...
Функция ПутьДляПолученияВерсииИнтерфейсаМенеджераСервиса()
	Возврат "/hs/ext-catalog/version";		
КонецФункции
...
Функция МенеджерСервисаПоддерживаетПолучениеРасширенийДляНовойОбласти()
	
	Возврат ВерсияПрограммногоИнтерфейсаМенеджераСервиса() >= 4; 
	
КонецФункции

Функция ВерсияПрограммногоИнтерфейсаМенеджераСервиса() 
	
	ПутьНаСервере = "";
	Соединение = СоединениеСМенеджеромСервиса(ПутьНаСервере);
	
	Запрос = Новый HTTPЗапрос(ПутьНаСервере + ПутьДляПолученияВерсииИнтерфейсаМенеджераСервиса());
